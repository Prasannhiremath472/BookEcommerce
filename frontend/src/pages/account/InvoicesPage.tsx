...
export function InvoicesPage() {
  ...
  return (
    <div>
      <h2 className="mb-5 font-heading text-lg font-bold text-ink">{t('invoices')}</h2>
      <div className="overflow-hidden rounded-2xl border border-ink/8 bg-white shadow-soft">
        <table className="w-full text-left text-sm">
          <thead className="bg-ink/[0.03] text-xs uppercase tracking-wide text-ink-muted">
            <tr>
              <th className="px-5 py-3 font-semibold">{t('invoiceCol')}</th>
              <th className="px-5 py-3 font-semibold">{t('orderCol')}</th>
