...
export const translations = {
  ...
  loginPasswordPrompt: { en: 'Enter your email and password to continue.', mr: 'सुरू ठेवण्यासाठी तुमचा ईमेल आणि पासवर्ड टाका.' },
  signupTitle: { en: 'Create your account', mr: 'तुमचे खाते तयार करा' },
  signupPrompt: { en: 'Sign up with your email to get started.', mr: 'सुरुवात करण्यासाठी तुमच्या ईमेलने साइन अप करा.' },
  emailAddress: { en: 'Email address', mr: 'ईमेल पत्ता' },
  passwordField: { en: 'Password', mr: 'पासवर्ड' },
  passwordTooShort: { en: 'Password must be at least 8 characters.', mr: 'पासवर्ड किमान 8 अक्षरांचा असावा.' },
  signingIn: { en: 'Please wait…', mr: 'कृपया प्रतीक्षा करा…' },
  createAccount: { en: 'Create Account', mr: 'खाते तयार करा' },
  needAccount: { en: "Don't have an account? Sign up", mr: 'खाते नाही? साइन अप करा' },
  haveAccount: { en: 'Already have an account? Sign in', mr: 'आधीच खाते आहे? साइन इन करा' },
